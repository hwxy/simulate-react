...
function diffChildren(dom, vchildren) {
  ...
  var children = [];
  var keyed = {}; // 将有key的节点（用对象保存）和 没有key的节点（用数组保存）分开

  if (domChildren.length > 0) {
    domChildren.forEach(function (c) {
      if (c.attributes && "key" in c.attributes) keyed[c.attributes["key"]] = c;else children.push(c);
    });
  }
...
function diffComponent(dom, vnode) {
  ...
  if (comp && comp.constructor === vnode.tag) {
    ...
    comp = (0, _index.createComponent)(vnode.tag, vnode.attts); // 设置组件属性
...
function diffAttribute(dom, vnode) {
  ...
  var domAttrs = _toConsumableArray(dom.attributes);
...
function _render(vnode) {
  ...
  if (typeof vnode.tag == 'function') {
    ...
    setComponentProps(comp, vnode.attrs); // 3. 组件渲染的节点对象返回 react函数式一个组件
...
},{"../component":"component.js","./diff":"react-dom/diff.js"}],"set_state_queue.js":[function(require,module,exports) {
"use strict";
...
},{"./react-dom":"react-dom/index.js"}],"component.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./react-dom":"react-dom/index.js","./set_state_queue":"set_state_queue.js"}],"react/index.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"../component":"component.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
var ele = _react.default.createElement("div", {
  className: "active",
  title: "123"
}, "hello, ", _react.default.createElement("span", null, "react")); // ReactDom.render('react', document.querySelector('#app'))
